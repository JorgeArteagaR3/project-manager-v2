...
export default function Navbar() {
    return (
        <nav
            className="fixed z-30 w-full h-20 bottom-0 grid grid-cols-3 place-items-center bg-[#0d0e10] text-center
        ...
        >
            ...
            {navlinks.map(({ path, name, Icon }) => (
                <Link
                    to={path}
                    className="w-full flex justify-center gap-4 lg:py-6 lg:rounded-xl lg:hover:bg-secondary lg:hover:text-white"
                >
